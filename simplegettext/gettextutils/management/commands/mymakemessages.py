...
class Command(BaseCommand):
    ...
    def handle(self, *args, **options):
        ...
        self.stdout.write(f'handle: Taken locale: {locale}')
    ...
    def build_potfiles(self):
        ...
        """
        self.stdout.write('build_potfiles: Start finding files ...')
        file_list = self.find_files(".")
        self.stdout.write(f'build_potfiles: Files list {file_list}', )
        self.remove_potfiles()
        ...
        for path in self.locale_paths:
            ...
            self.stdout.write(f'Run command {args}')
    ...
    def process_locale_dir(self, locale_dir, files):
        ...
        with NamedTemporaryFile(mode='w+') as input_files_list:
            ...
            self.stdout.write(f'Write message strings')
            msgs, errors, status = popen_wrapper(args)
